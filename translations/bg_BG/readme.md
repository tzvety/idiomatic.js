# Принципи за писане на свместим и идиоматичен JavaScript код
...
Проектите винаги трябва да включват общи средства които да форматират, тестват и сравняват кода при подготовката му за употреба. За това, [grunt](https://github.com/gruntjs/grunt) на Ben Alman.
...
Всички проекти _трябва_ да включват някаква форма на тестване. Потребителските демо тестове НЕ СЕ СЧИТАТ за реални "тестове". Това е списък на библиотеки за тестване, като нито една не би могла да се счита за приоритетна пред останалите.
